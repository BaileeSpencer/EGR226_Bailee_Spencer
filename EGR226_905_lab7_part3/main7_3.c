...
/****| scroll_str  | *****************************************
 * Brief: scrolls the string "LABORATORY OVER" across the first line of the LCD
 * param:
 *      n/a
 * return:
 *      n/a
 *************************************************************/
void scroll_str(void) {
    while (1){
                   char word[20] = "LABORATORY OVER";
                   write_command(0x01);
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   strcpy(word, "ABORATORY OVER");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   strcpy(word, "BORATORY OVER");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   strcpy(word, "ORATORY OVER");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   strcpy(word, "RATORY OVER");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   strcpy(word, "ATORY OVER");
                   print_string(word);
                   Systick_ms_delay(500);
                   write_command(0x01);
                   strcpy(word, "TORY OVER");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   strcpy(word, "ORY OVER");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   strcpy(word, "RY OVER");
                   ...
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x0F);
                   strcpy(word, "L");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x0E);
                   strcpy(word, "LA");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x0D);
                   strcpy(word, "LAB");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x0C);
                   strcpy(word, "LABO");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   ...
                   strcpy(word, "LABORATO");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x07);
                   strcpy(word, "LABORATOR");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x06);
                   strcpy(word, "LABORATORY");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   ...
                   strcpy(word, "LABORATORY O");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x03);
                   strcpy(word, "LABORATORY OV");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x02);
                   strcpy(word, "LABORATORY OVE");
                   print_string(word);
                   Systick_ms_delay(1000);
                   write_command(0x01);
                   write_command(0x80|0x01);
                   strcpy(word, "LABORATORY OVER");
                   print_string(word);
                   Systick_ms_delay(1000);
               }
}
